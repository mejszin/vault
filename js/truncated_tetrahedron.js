...
function setup() {
  ...
  dots = new Array;
  // Orange
  dots.push(new Dot(+3, +1, +1, "#FFA500"));
  dots.push(new Dot(+1, +3, +1, "#FFA500"));
  dots.push(new Dot(+1, +1, +3, "#FFA500"));
  // Green
  dots.push(new Dot(-3, -1, +1, "#00FF00"));
  dots.push(new Dot(-1, -3, +1, "#00FF00"));
  dots.push(new Dot(-1, -1, +3, "#00FF00"));
  // Blue
  dots.push(new Dot(-3, +1, -1, "#0000FF"));
  dots.push(new Dot(-1, +3, -1, "#0000FF"));
  dots.push(new Dot(-1, +1, -3, "#0000FF"));
  // Pink
  dots.push(new Dot(+3, -1, -1, "#FF69B4"));
  dots.push(new Dot(+1, -3, -1, "#FF69B4"));
  dots.push(new Dot(+1, -1, -3, "#FF69B4"));
  // Scale
